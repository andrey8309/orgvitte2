...
class RequestTicket(models.Model):
    ...
    equipment = models.ForeignKey(Equipment, on_delete=models.CASCADE, verbose_name="Оборудование", null=True, blank=True)
